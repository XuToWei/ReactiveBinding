...
namespace Test
{
    ...
    [Test]
    public async System.Threading.Tasks.Task ReactiveProtocol_HandwrittenGeneratedMemberAccessUsesVF10012()
    {
        var diagnostics = await GeneratorTestHelper.RunGeneratedReactiveProtocolAccessAnalyzer(@"
namespace Test
{
    public partial class Observer : IReactiveObserver
    {
        [ReactiveSource] public int Health { get; set; }

        [ReactiveBind(nameof(Health))]
        private void OnHealthChanged() { }

        public int ReadCache() => __reactive_Health;
        public void WriteCache() => __reactive_Health = 0;
    }
}");
    ...
    [Test]
    public async System.Threading.Tasks.Task ReactiveProtocol_HandwrittenDoubleUnderscoreMemberIsNotClaimed()
    {
        var diagnostics = await GeneratorTestHelper.RunVersionProtocolAccessAnalyzer(@"
namespace Test
{
    public class Observer : IReactiveObserver
    {
        public int __UserState;
        public void ObserveChanges() { }
        public void ResetChanges() { }
        public int Read() => __UserState;
    }
}");
    ...
    [Test]
    public async System.Threading.Tasks.Task ReactiveProtocol_HandwrittenGeneratedMethodInvocationUsesVF10012()
    {
        var diagnostics = await GeneratorTestHelper.RunReactiveProtocolGeneratedSourceFixture(@"
namespace Test
{
    public partial class Observer : IReactiveObserver
    {
        public void UseGeneratedMethod()
        {
            __generated_method();
            System.Action callback = __generated_method;
        }
    }
}", @"// <auto-generated/>
namespace Test
{
    public partial class Observer
    {
        public void ObserveChanges() { }
        public void ResetChanges() { }
        private void __generated_method() { }
    }
}");
