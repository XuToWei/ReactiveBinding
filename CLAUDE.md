...
- `__Parent` only accessible within `IVersion` implementations (VF30001); runtime ownership guards reject an `IVersion` instance appearing in more than one field/container slot
...
**RB2xxxx** (source): RB20001 void method | RB20002 no getter | RB20003 has params | RB20004 unsupported type | RB20005 no equality op | RB20006 duplicate source id
**RB3xxxx** (bind): RB30001 no ids | RB30002 static | RB30003 not void | RB30004 param count | RB30005 type mismatch | RB30006 duplicate | RB30007 no nameof | RB30008 no sources inferred | RB30009 auto-infer with params | RB30010 not marked source | RB30011 generic/ref/out/in callback
**VF1xxxx** (class): VF10001 not partial | VF10002 no IVersion | VF10003 inheritance unsupported | VF10004 generated member conflict
**VF2xxxx** (field): VF20001 no __ prefix | VF20002 not private | VF20003 property exists | VF20004 invalid modifiers | VF20005 invalid generated name
**VF3xxxx** (usage): VF30001 __Parent access | VF30002 direct field access | VF30003 field has initializer
**VS0xxx** (field/class): VS0001 unsupported synced field type (a `[VersionField]` in an `IVersionSync` class whose type can't be synchronized) | VS0002 synced object type missing public parameterless constructor

### Testing

`GeneratorTestHelper` provides: `RunGenerator()`, `RunVersionFieldGenerator()`, `RunReservedMethodAnalyzer()`, `RunObserveChangesCallAnalyzer()`, `RunParentAccessAnalyzer()`, `RunVersionInheritanceAnalyzer()`, `RunVersionFieldAccessAnalyzer()`, `RunVersionFieldInitializerAnalyzer()`, `RunVersionSyncFieldAnalyzer()`, and `CompileAndRun()` (compiles source + generated code into an in-memory assembly for execution-based round-trip sync tests)
